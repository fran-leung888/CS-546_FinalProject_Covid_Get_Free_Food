...
async function main() {
    ...
    const user1 = await users.createUser("user1", "password")
        .catch((err) => console.log(err))

    const user2 = await users.createUser("user2", "password")
        .catch((err) => console.log(err))


    const user3 = await users.createUser("user3", "password")
        .catch((err) => console.log(err))


    const user4 = await users.createUser("user4", "password")
        .catch((err) => console.log(err))


    const user5 = await users.createUser("user5", "password")
        .catch((err) => console.log(err))


    const user6 = await users.createUser("user6", "password")
        .catch((err) => console.log(err))


    const user7 = await users.createUser("user7", "password")
        .catch((err) => console.log(err))


    const user8 = await users.createUser("user8", "password")
        .catch((err) => console.log(err))

    const user9 = await users.createUser("user9", "password")
        .catch((err) => console.log(err))

    const user10 = await users.createUser("user10", "password")
        .catch((err) => console.log(err))
    ...
    const user1LikesFood2 = await users.createLikes(food2._id.toString(), user1)
        .catch((err) => console.log(err))

    const user2LikesFood2 = await users.createLikes(food2._id.toString(), user2)
        .catch((err) => console.log(err))

    const user3LikesFood2 = await users.createLikes(food2._id.toString(), user3)
        .catch((err) => console.log(err))

    const user4LikesFood2 = await users.createLikes(food2._id.toString(), user4)
        .catch((err) => console.log(err))

    const user5LikesFood2 = await users.createLikes(food2._id.toString(), user5)
        .catch((err) => console.log(err))

    const user1LikesFood1 = await users.createLikes(food1._id.toString(), user1)
        .catch((err) => console.log(err))

    const user2LikesFood1 = await users.createLikes(food1._id.toString(), user2)
        .catch((err) => console.log(err))
    ...
    const user1OrdersFood1By1 = await foods.orderFood( food1._id.toString(),user1,1)
        .catch((err) => console.log(err))


    const user1OrdersFood2By2 = await foods.orderFood( food2._id.toString(),user1,2)
        .catch((err) => console.log(err))
